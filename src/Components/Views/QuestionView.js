                ...
                <div className="Qmodal-question">          
                    ...
                    <Swiper pagination={{"type": "progressbar"}} navigation={true} className="mySwiper">
                        ...
                        <SwiperSlide>
                                ...
                                <div className="div-descriptions"><span className="descriptions">Step 3. Click the 'Recommend' button to get your recommended shortest location for your cookout</span></div>
                            </SwiperSlide>
                        <SwiperSlide>
                                <img className="pictures" src={require(`../../img/Tutorials/step4.png`).default} />
                                <div className="div-descriptions"><span className="descriptions">Step 4. Scroll to see kitchen choices and to look for kitchen details.</span></div>
                            </SwiperSlide>
                        <SwiperSlide>
                                <img className="pictures" src={require(`../../img/Tutorials/step5.png`).default} />
                                <div className="div-descriptions"><span className="descriptions">Step 5. If you want to buy ingredients, choose the amount you want to buy through + and - signs.</span></div>
                            </SwiperSlide>
                        <SwiperSlide>
                                <img className="pictures" src={require(`../../img/Tutorials/step6.png`).default} />
                                <div className="div-descriptions"><span className="descriptions">Step 6. Choose your prefered date and time and reserve.</span></div>
                            </SwiperSlide>    
                        <SwiperSlide>
                                <img className="pictures" src={require(`../../img/Tutorials/step6.png`).default} />
