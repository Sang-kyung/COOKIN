                ...
                <div className="Qmodal-question">          
                    ...
                    <SwiperSlide>
                        ...
                        <SwiperSlide>
                                ...
                                <div className="div-descriptions"><span className="descriptions">Step 2. Type the one of your location and enter.</span></div>
                            </SwiperSlide>
                        <SwiperSlide>
                                <img className="pictures" src={require(`../../img/Tutorials/step3.png`).default} />
                                <div className="div-descriptions"><span className="descriptions">Step 3. Keep registering your locations one by one.</span></div>
                            </SwiperSlide>
                        <SwiperSlide>
                                <img className="pictures" src={require(`../../img/Tutorials/step4.png`).default} />
                                <div className="div-descriptions"><span className="descriptions">Step 4. Click 'fetch' button to recommend your shortest location to cookout</span></div>
                            </SwiperSlide>
                        <SwiperSlide>
                                <img className="pictures" src={require(`../../img/Tutorials/step5.png`).default} />
                                <div className="div-descriptions"><span className="descriptions">Step 5. Click certain kitchen to look for specifications.</span></div>
                            </SwiperSlide>
                        <SwiperSlide>
                                <img className="pictures" src={require(`../../img/Tutorials/step6.png`).default} />
                                <div className="div-descriptions"><span className="descriptions">Step 6. Check the options and make a reservation.</span></div>
                            </SwiperSlide>
                        <SwiperSlide>
                                <img className="pictures" src={require(`../../img/Tutorials/step7.png`).default} />
                                <div className="div-descriptions"><span className="descriptions">Step 7. In My Page, check or cancel your reservation information.</span></div>
                            </SwiperSlide>
                        </Swiper>
